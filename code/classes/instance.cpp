...
class OSAPInstance {
    public:
        ...
        /* HillClimbingBI() gets a solution generated by the greedy algorithm and 
        *  iteratively improves the solution quality by picking random movements.
        */
                ...
                for (int i = 0; i < (int) roomsVector.size(); i++) {
                    ...
                    if (find(visitedRooms[entity.id].begin(), visitedRooms[entity.id].end(), roomsVector[i].id) == visitedRooms[entity.id].end()) {
                        ...
                        if (checkHardConstraints(partialSolution) == 1) {
                            ...
                            // Calc penalty
                            penalty = objFunction(partialSolution);
    ...
    private:
        ...
        *  all the entities allocated to r1 to r2, and viceversa
        */
        ...
        */
        float calcSoftPenalty(vector<int> solution) {
            ...
            for (auto constraint : softConstraints) {
                if (constraint.checkConstraint(solution, entitiesVector, roomsVector) == 0) {
